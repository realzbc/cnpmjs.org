...
exports.isPrivateScopedPackage = function* (name) {
  ...
  var allPrivateScopesArr = allPrivateScopes.map(e => e.name);
  return config.scopes.indexOf(name.split('/')[0]) >= 0 || allPrivateScopesArr.indexOf(name.split('/')[0]) >= 0;
};

exports.getUserInfoByEmail = function (email) {
